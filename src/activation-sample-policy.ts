...
export interface ActivationSamplePolicy {
  ...
  // essentially, when two conditions are combined with an AndOperator one should take precedence over the _other
  // immediate transitions into anything and straight_random/all_corner_random dominate everything except each _other
  // NB. currently there are no skills that combine straight_random or all_corner_random with anything _other than
  // immediate conditions (running_style or distance_type), and obviously they are mutually exclusive with each _other
  ...
  reconcile(_other: ActivationSamplePolicy): ActivationSamplePolicy;
  reconcileImmediate(_other: ActivationSamplePolicy): ActivationSamplePolicy;
  reconcileDistributionRandom(_other: ActivationSamplePolicy): ActivationSamplePolicy;
  reconcileRandom(_other: ActivationSamplePolicy): ActivationSamplePolicy;
  reconcileStraightRandom(_other: ActivationSamplePolicy): ActivationSamplePolicy;
  reconcileAllCornerRandom(_other: ActivationSamplePolicy): ActivationSamplePolicy;
}
...
export const ImmediatePolicy = Object.freeze({
  ...
  reconcile(_other: ActivationSamplePolicy) {
    return _other.reconcileImmediate(this);
  },
  reconcileImmediate(_other: ActivationSamplePolicy) {
    return _other;
  },
  reconcileDistributionRandom(_other: ActivationSamplePolicy) {
    return _other;
  },
  reconcileRandom(_other: ActivationSamplePolicy) {
    return _other;
  },
  reconcileStraightRandom(_other: ActivationSamplePolicy) {
    return _other;
  },
  reconcileAllCornerRandom(_other: ActivationSamplePolicy) {
    return _other;
  },
});
...
export const RandomPolicy = Object.freeze({
  ...
  reconcile(_other: ActivationSamplePolicy) {
    return _other.reconcileRandom(this);
  },
...
export abstract class DistributionRandomPolicy {
  ...
  reconcile(_other: ActivationSamplePolicy) {
    return _other.reconcileDistributionRandom(this);
  }
  reconcileImmediate(_: ActivationSamplePolicy) {
    return this;
  }
  reconcileDistributionRandom(_other: ActivationSamplePolicy) {
    ...
    // probably this should be the joint probability distribution of `this` and `_other`, but that is too complex to implement
    ...
    // (this would also enable _other features like cooldowns for distribution-random skills).
    return this;
  }
...
export class ErlangRandomPolicy extends DistributionRandomPolicy {
  ...
  distribution(upper: number, nsamples: number, rng: PRNG) {
    ...
    // the _other problem is that an erlang distribution has support [0,∞), so there's no sensible upper bound
...
export const StraightRandomPolicy = Object.freeze({
  ...
  reconcile(_other: ActivationSamplePolicy) {
    return _other.reconcileStraightRandom(this);
  },
  reconcileImmediate(_: ActivationSamplePolicy) {
    return this;
  },
...
export const AllCornerRandomPolicy = {
  ...
  reconcile(_other: ActivationSamplePolicy) {
    return _other.reconcileAllCornerRandom(this);
  },
  reconcileImmediate(_: ActivationSamplePolicy) {
    return this;
  },
