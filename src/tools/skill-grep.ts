...
import { mockConditions, treeMatch } from './condition-matcher';
...
program
  .argument(
    '<condition>',
    'Condition to search for. May be a condition name (e.g. blocked_side_continuetime), an expression (corner==0&order_rate<80), or, if --name is specified, a skill name.',
  )
