...
Reads an uma definition file and takes skills on the command line and simulates a race with and without the specified skills to report statistics about their effects in terms of バ身 gain. See front.json, pace.json, etc to get an idea of the definition format.
...
- front.json has inherited アングリング × スキーミング
- pace.json has inherited つぼみ、ほころぶ時
- late.json has inherited レッツ・アナボリック！
- end.json has 直線一気
