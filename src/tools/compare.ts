...
import { PendingSkill, RaceSolver } from '../race-solver';
import { Rule30CARng } from '../random';
import { Region, RegionList } from '../region';
import { SkillData, buildHorseParameters, buildSkillData } from './cli';
...
const course = getCourse(opts.course);
...
for (let i = 0; i < opts.nsamples; ++i) {
  const skills1 = [];
  // Ensure gain is typed as number[]
  // gain is already typed as number[]
