...
const cases = [
  {
    ...
    paceEffectsEnabled: false,
    nsamples: 609,
    presupposedSkills: ['201382', '201173', '100651', '110181', '202481', '120131', '900101', '200241', '900601'],
    skillsUnderTest: ['201671', '201121', '202011'],
  },
  {
    seed: 0,
    courseId: '10205',
  ...
  },
  {
    ...
    paceEffectsEnabled: false,
    nsamples: 131,
    presupposedSkills: ['202102', '900521'],
    skillsUnderTest: ['200311', '201662'],
  },
  {
    seed: -1465258475,
    courseId: '10605',
...
test('no regressions on known cases', (t) => {
  ...
  cases.forEach((testCase) => {
    ...
    let ok = true;
    CASE: for (let i = 0; i < testCase.nsamples; ++i) {
      ...
      while (s.pos < builder._course.distance) {
        ...
        if (s.pos <= lastPos && s.pos != 0) {
          console.error(
            'err: not moving or going backwards: time: ' +
              s.accumulatetime.t +
              ' pos: ' +
              s.pos +
              ' lastPos: ' +
