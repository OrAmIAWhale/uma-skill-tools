...
const trackExceptHorse = {
  strategy: ['Front', 'Pace', 'Late', 'End', 'Escape'],
...
const initialState = {
  preSkillsSeen: Object.create(null),
  sutSkillsSeen: Object.create(null),
};
...
console.log(
  trackMinmaxHorse.map((prop) => prop + ' ' + results['min$' + prop] + '~' + results['max$' + prop]).join('\n'),
);
